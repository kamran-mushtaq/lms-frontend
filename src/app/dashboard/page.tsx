    ...
    try {
      ...
      if (classesData && classesData.length > 0) {
        ...
        for (const classItem of classesData) {
          ...
          // Filter subjects that student is enrolled in and has passed aptitude test
          const enrolledSubjectIds = enrollmentsData
            .filter((enrollment: any) => 
              enrollment.classId._id === classItem._id || 
              enrollment.classId === classItem._id
            )
            .filter((enrollment: any) => enrollment.aptitudeTestPassed)
            .map((enrollment: any) => 
                ...
                {classes.map((classItem) => (
                  ...
                  >
                    ...
                    <Badge variant="outline">
                      {subjects.filter((s) => s.classId === classItem._id).length} subjects
                    </Badge>
                  </div>
                ))}
              </div>
